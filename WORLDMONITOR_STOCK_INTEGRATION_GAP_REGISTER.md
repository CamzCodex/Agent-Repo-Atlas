...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| WM-001 | High | World Monitor | Current PR #10 head was never exactly validated | Run `29881947809` targeted `0295244`; PR head is `b9568b8` | False green/unsafe merge | Draft PR | Validate final published SHA | World Monitor maintainer | WP1 fixes | Workflow target and head equality | Open |
